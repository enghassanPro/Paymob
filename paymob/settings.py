...
ALLOWED_HOSTS = [k for k in config('ALLOWED_HOSTS').split(",") if k]
...
REST_KNOX = {
    'TOKEN_TTL': timedelta(minutes=int(config('KNOX_TOKEN_TTL'))) if config('KNOX_TOKEN_TTL') != '' else None,
    'TOKEN_LIMIT_PER_USER': int(config('KNOX_TOKEN_LIMIT_PER_USER')) if config('KNOX_TOKEN_LIMIT_PER_USER') != '' else None,
    # 'AUTH_HEADER_PREFIX': '',
}
